    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Badges", x => x.Number);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicFacingProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublicFacingProfiles_Organizers_OrganizerId",
                        column: x => x.OrganizerId,
                        principalTable: "Organizers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicFacingProfiles_OrganizerId",
                table: "PublicFacingProfiles",
                column: "OrganizerId",
                unique: true);
        }
